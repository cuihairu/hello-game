    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '游戏核心技术总览', link: '/24-game-types-architecture/03-core-technologies' },
          { text: '通信协议设计', link: '/24-game-types-architecture/04-protocol-design' },
          { text: 'P2P 架构与 NAT 穿越', link: '/24-game-types-architecture/05-p2p-architecture' },
          { text: '容量规划与系统结构', link: '/24-game-types-architecture/06-capacity-planning' },
